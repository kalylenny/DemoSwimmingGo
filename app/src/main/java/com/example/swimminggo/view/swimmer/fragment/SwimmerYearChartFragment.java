...
public class SwimmerYearChartFragment extends Fragment {
    ...
    public SwimmerYearChartFragment(int swimmerId){
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        view = inflater.inflate(R.layout.fragment_swimmer_year_chart, container, false);
        initComponent();
        initDatabase();
        action();
        return view;
    ...
    private void action() {
        btnViewChart.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                chartPresenter.onGetDataByYear(CurrentStyle.getInstance().getStyle().getId(),
